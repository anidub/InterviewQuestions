...
//Given a number, find the next greater number using same digits(or by rearranging the digits).
	//For example, if the given number is 1234 then next greater number would be 1243.
	//For the input 1243, next greater number would be 1324. If the input is 6938652 then the output should be the number 6952368.
  private void swap(int[] number, int i, int j)   {
	    ...
	    public void findNextGreaterNumber(int[] number)  {
	        ...
	        System.out.println(lastDigitSeen);
	    ...
	    public static void main(String[] args)    {
	       nextgreaternumberwithsamedigits solution = new nextgreaternumberwithsamedigits();    
