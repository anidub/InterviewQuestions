...
public class shortestSubarrayinBigArray {
/*
 * https://www.careercup.com/question?id=5663291826241536
 * 	Given an array: 1,2,3 ,5,8,7,6,9,5,7,3,0,5 
subarry:5,7 
Find the subarray in the large array and return the minimum length 
and index where you can find the subarray.
 ...
 */
	public static void main(String[] args) {
		int[] arr = {1,2,3,5,8,7,6,9,5,45,89,7,3,0,5};
		int[] subarr = {5,7};
		printMinLength(arr,subarr);
	}
